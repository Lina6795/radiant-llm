...
def _load_env():
    ...
    global_env = Path.home() / ".config" / "visual-rag" / ".env"
...
class ParserConfig:
    ...
    """Latest GPT vision model.  Also accepts: gpt-5, gpt-5.1, gpt-4o, gpt-4.1"""

    # GPT-5.x reasoning effort: none | low | medium | high | xhigh (xhigh = gpt-5.2 only)
    ...
    def from_env(cls) -> "ParserConfig":
        ...
        return cls(
            ...
            max_workers          = int(os.getenv("VISUAL_PARSER_MAX_WORKERS", "1")),
