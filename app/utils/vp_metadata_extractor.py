"""
metadata_extractor.py â€” Extract document-level metadata (title, authors, DOI â€¦)
...
from utils.vp_prompts import METADATA_PROMPT_TEMPLATE
...
def extract_pdf_metadata(
    ...
    Returns:
        ...
        doi, keywords â€” plus a ``_source`` entry with the PDF basename.
