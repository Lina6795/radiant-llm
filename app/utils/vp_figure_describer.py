"""
figure_describer.py â€” Rasterise every page of each PDF at high DPI and send
...
from utils.vp_prompts import FIGURE_PROMPT
from utils.vp_vision_llm import call_vision_llm
...
def describe_figures_for_new_pdfs(
    ...
    """
    # -----------------------------------------------------------------------
    # Step 1 â€“ Rasterise every page of every new PDF
    # -----------------------------------------------------------------------
    ...
    # -----------------------------------------------------------------------
    # Step 2 â€“ Group page images by PDF name
    # -----------------------------------------------------------------------
    ...
    # -----------------------------------------------------------------------
    # Step 3 â€“ Call Vision LLM once per page
    # -----------------------------------------------------------------------
    ...
    # -----------------------------------------------------------------------
    # Step 4 â€“ Write figure descriptions to 02_visuals_kb.jsonl
    # -----------------------------------------------------------------------
    ...
    if figure_rows:
        ...
        logger.info("No figures detected â€” 02_visuals_kb.jsonl not updated.")
